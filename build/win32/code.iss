...
AppPublisher=Blackbox Factories
AppPublisherURL=https://blackboxfactories.com/
AppSupportURL=https://blackboxfactories.com/
AppUpdatesURL=https://blackboxfactories.com/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=BlackBoxCodeSetup
Compression=lzma
...
begin
  Result := True;
    ...
    if not WizardSilent() and IsAdmin() then begin
      if MsgBox('This User Installer is not meant to be run as an Administrator. If you would like to install {#NameLong} for all users in this system, download the System Installer instead. Are you sure you want to continue?', mbError, MB_OKCANCEL) = IDCANCEL then begin
        Result := False;
      end;
    end;
  #endif
