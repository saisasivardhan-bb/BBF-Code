...
async function main() {
	...
	const claudeMdLinkType = ensureAgentHarnessLink(path.join('..', '.agents', 'CODING-GUIDELINES.md'), claudeMdLink);
	if (claudeMdLinkType !== 'existing') {
		log('.', `Created ${claudeMdLinkType} .claude/CLAUDE.md -> .agents/CODING-GUIDELINES.md`);
	}
