...
function configureCrashReporter(): void {
	...
	const submitURL = ''; // BBF: never upload crash reports
	...
	// BBF: Microsoft App Center crash upload removed. Crash dumps stay local;
	// they are only written to disk when --crash-reporter-directory is passed.

	// Start crash reporter for all processes
	const productName = (product.crashReporter ? product.crashReporter.productName : undefined) || product.nameShort;
	const companyName = (product.crashReporter ? product.crashReporter.companyName : undefined) || 'Blackbox Factories';
