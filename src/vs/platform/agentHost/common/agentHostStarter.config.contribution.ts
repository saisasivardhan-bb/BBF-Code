...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[AgentHostGitHubMcpServerEnabledSettingId]: {
			...
			// BBF: GitHub's own MCP server is not part of this product.
			default: false,
			tags: ['experimental', 'advanced'],
			experiment: { mode: 'startup' },
		...
		[AgentHostClaudeAgentEnabledSettingId]: {
			...
			// BBF: ships BBF AI Coder, not third-party agent providers.
			default: false,
			tags: ['experimental', 'advanced'],
		...
		[AgentHostCodexAgentEnabledSettingId]: {
			...
			// BBF: off by default. Upstream enables this outside stable builds, and a
			// dev build has no quality, so Codex registered itself and put ChatGPT in
			// the Accounts menu. AI providers are out of scope for BBF Code.
			default: false,
			tags: ['experimental', 'advanced'],
