...
// BBF: the Agents window loads this main file, not workbench.common.main, so it
// needs the chat-setup shim too or sessionsSetUpService throws at startup.
import '../workbench/contrib/bbf/browser/bbfChatSetup.contribution.js';
